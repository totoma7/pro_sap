...
**구성: 본 과정 5차시(11편) + 심화 14편 + 인터랙티브 1편 + 공정 다이어그램 1편 + 레퍼런스 1편 — 총 28개 레슨 완성**
...
| 심화 10 | [반도체 장기계약](https://totoma7.github.io/pro_sap/lessons/A-10-semicon-contracts.html) | LTA·생산능력 예약(Capacity Reservation·Take-or-Pay), 장비 유지보수 계약(CSA·가동률 SLA) |
| 심화 11 | [반도체 품질·신뢰성과 공급 리스크](https://totoma7.github.io/pro_sap/lessons/A-11-semicon-quality-risk.html) | 공급사 인증(Qual), 변경관리(PCN·EOL), 8D·SCAR·PPAP, 공급망 리스크 맵·BCP |
| 심화 12 | [마스크·NRE·IP (팹리스·파운드리)](https://totoma7.github.io/pro_sap/lessons/A-12-semicon-mask-nre-ip.html) | IDM/팹리스/파운드리 모델, IP 라이선스·NRE·마스크(레티클), 무형·일회성·양산 3층 구조 |
...
| 심화 14 | [업체별 특징·구매 전략](https://totoma7.github.io/pro_sap/lessons/A-14-semicon-suppliers.html) | 밸류체인 플레이어 지도, 유형별 협상력, Kraljic 4분면 포트폴리오, 슈퍼 을 대응 |
...
| 레슨 | 핵심 내용 |
|---|---|
| [반도체 제조 공정 다이어그램](https://totoma7.github.io/pro_sap/lessons/P-1-semicon-process.html) | Mermaid 6단계 공정도(설계~출하 + FAB 반복 + 공통지원), 공정별 소비 자재·장비 매핑, 공정×구매 업무 프로세스 맵(두 피드백 루프) |
...
├── lessons/              # 레슨 페이지 21편
│   ├── 01-* ~ 05-*       # 본 과정 (5차시 11편)
│   ├── A-1 ~ A-14        # 심화 14편 (A-5~A-14는 반도체 시리즈)
│   ├── I-1               # 인터랙티브 P2P 시뮬레이터
